// src/pages/Manufacturers/EditManufacturer.jsx
...
const EditManufacturer = () => {
  ...
  useEffect(() => {
    const fetchManufacturer = async () => {
      ...
      try {
        ...
        console.error("Fetch manufacturer error:", error);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await manufacturersApi.update(id, formData);
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6">
          ...
          <Card className="bg-white max-w-4xl mx-auto">
            <CardHeader>
              <CardTitle className="text-gray-800">Edit Manufacturer Information</CardTitle>
            </CardHeader>
            <CardContent>
